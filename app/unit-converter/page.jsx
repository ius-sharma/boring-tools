  ...
  return (
    <div ref={rootRef} className="relative w-full">
      ...
      >
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className={`theme-dropdown-chevron h-5 w-5 shrink-0 text-neutral-500 transition-transform ${open ? "rotate-180" : "rotate-0"}`}>
