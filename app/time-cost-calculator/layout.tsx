...
const tool = tools.find((t) => t.id === "time-cost-calculator") || {
  id: "time-cost-calculator",
  name: "Time Cost Calculator",
  href: "/time-cost-calculator",
  category: "Finance",
  description: "Calculate the real cost of purchases in terms of work hours, working days, and savings required.",
  status: "Live",
};
