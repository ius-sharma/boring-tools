...
const tool = tools.find((t) => t.id === "math-formula-calculator") || {
  id: "math-formula-calculator",
  name: "Math Formula Calculator",
  href: "/math-formula-calculator",
  category: "Education",
  description: "Calculate algebra, geometry, trigonometry, and statistics formulas.",
  status: "Live",
};
