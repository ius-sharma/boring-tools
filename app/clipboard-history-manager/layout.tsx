...
const tool = tools.find((t) => t.id === "clipboard-history-manager") || {
  id: "clipboard-history-manager",
  name: "Clipboard History Manager",
  href: "/clipboard-history-manager",
  category: "Productivity",
  description: "Store and manage multiple copied texts in one place offline.",
  status: "Live",
};
