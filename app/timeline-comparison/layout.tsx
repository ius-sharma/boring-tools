...
const tool = tools.find((t) => t.id === "timeline-comparison") || {
  id: "timeline-comparison",
  name: "Timeline Comparison",
  href: "/timeline-comparison",
  category: "Education",
  description: "Visually compare two historical civilizations, empires, inventions, technologies, or events side-by-side across time.",
  status: "Live",
};
