...
const tool = tools.find((t) => t.id === "history-repeats") || {
  id: "history-repeats",
  name: "History Repeats",
  href: "/history-repeats",
  category: "Education",
  description: "Compare modern situations to historical events, revealing patterns, similarities, differences, and key lessons.",
  status: "Live",
};
