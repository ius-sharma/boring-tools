...
const tool = tools.find((t) => t.id === "personal-admin-dashboard") || {
  id: "personal-admin-dashboard",
  name: "Personal Admin Dashboard",
  href: "/personal-admin-dashboard",
  category: "Productivity",
  description: "Manage passport, license, insurance, documents, and reminders all in one place, stored completely offline.",
  status: "Live",
};
