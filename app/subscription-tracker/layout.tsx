...
const tool = tools.find((t) => t.id === "subscription-tracker") || {
  id: "subscription-tracker",
  name: "Subscription Tracker",
  href: "/subscription-tracker",
  category: "Finance",
  description: "Track recurring subscriptions, view monthly/yearly breakdowns, renewal schedules, and spending insights.",
  status: "Live",
};
