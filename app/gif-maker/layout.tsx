...
const tool = tools.find((t) => t.id === "gif-maker") || {
  id: "gif-maker",
  name: "GIF Maker from Images",
  href: "/gif-maker",
  category: "Media",
  description: "Create animated GIFs from multiple images with custom transitions, delays, text overlays, and filters 100% locally.",
  status: "Live",
};
