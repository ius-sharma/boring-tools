...
const tool = tools.find((t) => t.id === "geography-quiz") || {
  id: "geography-quiz",
  name: "Geography Quiz & Map Explorer",
  href: "/geography-quiz",
  category: "Education",
  description: "Explore countries, capitals, flags and world maps through interactive quizzes and challenges.",
  status: "Live",
};
