...
const tool = tools.find((t) => t.id === "before-after") || {
  id: "before-after",
  name: "Before & After",
  href: "/before-after",
  category: "Education",
  description: "Explore how life changed before and after major inventions, scientific discoveries, and historical breakthroughs.",
  status: "Live",
};
