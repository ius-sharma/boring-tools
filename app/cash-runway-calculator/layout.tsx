...
const tool = tools.find((t) => t.id === "cash-runway-calculator") || {
  id: "cash-runway-calculator",
  name: "Cash Runway Calculator",
  href: "/cash-runway-calculator",
  category: "Finance",
  description: "Calculate startup runway, burn rate and survival time using revenue and expenses.",
  status: "Live",
};
