...
const tool = tools.find((t) => t.id === "link-intelligence") || {
  id: "link-intelligence",
  name: "Link Intelligence",
  href: "/link-intelligence",
  category: "Security",
  description: "Deconstruct URLs to analyze parameters, identify trackers, check safety indicators, and clean tracking tags.",
  status: "Live",
};
