...
const tool = tools.find((t) => t.id === "cosmic-calendar") || {
  id: "cosmic-calendar",
  name: "Cosmic Calendar",
  href: "/cosmic-calendar",
  category: "Education",
  description: "Understand the scale of time by compressing the history of the universe into a calendar year and comparing it to your life.",
  status: "Live",
};
