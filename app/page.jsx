...
const tools = [
  ...
  { id: "social-account-analyzer", name: "Social Account Analyzer", href: "/social-account-analyzer", category: "Creator Tools", description: "Check Instagram or YouTube account health — spam followers, consistency & growth.", status: "Upcoming", isNew: true },
];
