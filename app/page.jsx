...
const tools = [
  ...
  { id: "cosmic-address", name: "Cosmic Address", href: "/cosmic-address", category: "Learning", description: "Trace your exact location in the universe, zooming out from yourself to the edge of the observable universe with interactive visualizations.", status: "Upcoming", isNew: true, isFeatured: true },
...
const liveToolIds = new Set([
  "text-formatter", "text-to-morse-code", "json-formatter", "word-counter", "password-generator", "age-calculator", "bmi-calculator", "water-intake-calculator", "birthday-countdown", "age-difference-calculator", "discount-calculator", "purchase-intelligence", "time-cost-calculator", "sip-calculator", "emi-calculator", "unit-converter", "qr-generator", "file-name-sanitizer", "pomodoro-timer", "image-compressor", "image-to-pdf-converter", "doc-to-pdf-converter", "pdf-intelligence-tool", "document-data-extractor", "resume-bullet-rewriter", "resignation-letter-generator", "time-zone-converter", "days-between-dates", "to-do-list", "gst-calculator", "truth-or-dare-play", "roast-my-todo-list", "markdown-previewer", "video-transcriber", "youtube-title-generator", "base-converter", "aspect-ratio-calculator", "distance-between-cities", "currency-converter", "linkedin-post-formatter", "what-happened-today", "math-formula-calculator", "science-formulas-calculator", "concept-explorer", "can-i-trust-this-website", "news-accuracy-checker", "link-intelligence", "social-account-analyzer", "attendance-calculator", "youtube-downloader", "video-to-audio-converter", "terms-conditions-simplifier", "percentage-calculator", "typing-speed-tester", "calorie-calculator", "hook-generator", "sleep-cycle-calculator", "color-palette-generator", "invoice-generator", "should-i-reply", "subscription-tracker", "personal-admin-dashboard", "email-decoder", "learning-os", "leverage-finder", "clipboard-history-manager", "digital-declutter-assistant", "second-mind", "fear-decomposer", "perspective-switcher", "history-repeats", "empire-simulator", "before-after", "if-this-never-happened", "timeline-comparison", "historical-perspective", "cosmic-calendar", "your-weight-on-other-planets", "time-on-other-planets", "cgpa-target-planner"
]);

const featuredToolIds = ["perspective-switcher", "fear-decomposer", "hook-generator", "sleep-cycle-calculator", "calorie-calculator"];
