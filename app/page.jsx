...
const tools = [
  ...
  { id: "water-intake-calculator", name: "Water Intake Calculator", href: "/water-intake-calculator", category: "Health", description: "Estimate daily water intake from age, weight, activity, and climate.", status: "Upcoming", isNew: true },
  ...
  { id: "sip-calculator", name: "SIP Calculator", href: "/sip-calculator", category: "Finance", description: "Estimate future SIP returns with monthly compounding and growth charts.", status: "Upcoming", isNew: true, isFeatured: true },
  ...
  { id: "terms-conditions-simplifier", name: "Terms & Conditions Simplifier", href: "/terms-conditions-simplifier", category: "Documents", description: "Simplify legal text into plain language with a summary, obligations, risks, and permissions.", status: "Upcoming", isNew: true },
  ...
  { id: "percentage-calculator", name: "Percentage Calculator", href: "/percentage-calculator", category: "Finance", description: "Solve common percentage questions instantly.", status: "Upcoming", isNew: true },
