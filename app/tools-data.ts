...
const rawTools: Tool[] = [
  ...
  { id: "json-formatter", name: "JSON Formatter", href: "/json-formatter", category: "Developer", description: "Format and validate JSON in one click.", status: "Live" },
  {
    ...
    href: "/qr-generator",
    category: "Developer",
    description: "Generate custom, high-resolution QR codes for URLs, Wi-Fi, contacts, WhatsApp and payments. 100% client-side privacy.",
    status: "Live",
    isNew: true,
    isFeatured: true,
    seoTitle: "Free QR Code Generator (Wi-Fi, vCard, SVG & PNG) | BoringTools",
    seoDescription: "Create customized, high-resolution QR codes for websites, Wi-Fi passwords, vCards, WhatsApp and UPI. 100% private and in-browser with zero tracking.",
    keywords: ["qr code generator", "wifi qr code", "free qr generator", "vcard qr code", "svg qr code", "private qr code generator"],
    relatedToolIds: ["password-generator", "link-intelligence", "base-converter", "text-formatter"]
  },
  ...
  { id: "link-intelligence", name: "Link Intelligence", href: "/link-intelligence", category: "Security", description: "Deconstruct URLs to analyze parameters, identify trackers, check safety indicators, and clean tracking tags.", status: "Live", isNew: true, isFeatured: true },
  {
    ...
    status: "Live",
    seoTitle: "Free Age Calculator — Calculate Exact Age from Date of Birth | BoringTools",
    seoDescription: "Calculate your exact age in years, months, weeks, days, and minutes from your date of birth. 100% free, private, and instant.",
    keywords: ["age calculator", "calculate age online", "chronological age calculator", "date of birth calculator", "exact age checker"],
    relatedToolIds: ["birthday-countdown", "age-difference-calculator", "days-between-dates", "time-zone-converter"]
  },
  {
    id: "bmi-calculator",
    name: "BMI Calculator",
    ...
    isNew: true,
    isFeatured: true,
    seoTitle: "Free BMI Calculator & Healthy Weight Range Checker | BoringTools",
    seoDescription: "Calculate your Body Mass Index (BMI), WHO classification, and healthy weight range instantly in metric or imperial units. No signup required.",
    keywords: ["bmi calculator", "body mass index calculator", "calculate bmi online", "ideal weight calculator", "healthy weight checker"],
    relatedToolIds: ["water-intake-calculator", "calorie-calculator", "sleep-cycle-calculator", "reaction-time-tester"]
  },
  {
    ...
    isNew: true,
    isFeatured: true,
    seoTitle: "Daily Water Intake Calculator (Age, Weight & Climate) | BoringTools",
    seoDescription: "Calculate your recommended daily water consumption in liters and glasses based on weight, activity level, and climate.",
    keywords: ["water intake calculator", "daily water requirement calculator", "how much water should i drink", "hydration calculator"],
    relatedToolIds: ["bmi-calculator", "calorie-calculator", "sleep-cycle-calculator", "attendance-calculator"]
  },
  ...
  { id: "freelancer-pricing-calculator", name: "Freelancer Pricing Calculator", href: "/freelancer-pricing-calculator", category: "Finance", description: "Calculate profitable freelance hourly, daily, and project rates based on income goals, expenses, taxes, experience, and project scope.", status: "Live", isNew: true, isFeatured: true },
  ...
  { id: "time-cost-calculator", name: "Time Cost Calculator", href: "/time-cost-calculator", category: "Finance", description: "Calculate the real cost of purchases in terms of work hours, working days, and savings required.", status: "Live", isNew: true, isFeatured: true },
  {
    ...
    isNew: true,
    isFeatured: true,
    seoTitle: "Free SIP Calculator Online — Mutual Fund Compounding & Growth | BoringTools",
    seoDescription: "Calculate future returns on your Systematic Investment Plan (SIP) with monthly compounding, growth charts, and estimated wealth gain.",
    keywords: ["sip calculator", "mutual fund sip calculator", "systematic investment plan calculator", "compounding calculator", "sip return calculator"],
    relatedToolIds: ["emi-calculator", "cash-runway-calculator", "discount-calculator", "time-cost-calculator"]
  },
  {
    id: "emi-calculator",
    name: "EMI Calculator",
    ...
    isNew: true,
    isFeatured: true,
    seoTitle: "Free EMI Calculator — Loan Monthly Installment & Interest Breakdown | BoringTools",
    seoDescription: "Calculate monthly loan EMIs, total interest payable, and amortization breakdown for home loans, car loans, and personal loans.",
    keywords: ["emi calculator", "loan emi calculator", "home loan emi calculator", "monthly installment calculator", "interest calculator"],
    relatedToolIds: ["sip-calculator", "discount-calculator", "cash-runway-calculator", "time-cost-calculator"]
  },
  {
    id: "qr-generator",
    name: "QR Generator",
    ...
    status: "Live",
    seoTitle: "Free QR Code Generator Online (Custom Colors & High-Res) | BoringTools",
    seoDescription: "Create high-resolution QR codes from text, URLs, and WiFi with customizable foreground and background colors. Instant download, no sign-up.",
    keywords: ["qr code generator", "free qr generator", "custom qr code maker", "qr code generator online", "no signup qr maker"],
    relatedToolIds: ["link-intelligence", "password-generator", "image-compressor", "fake-data-generator"]
  },
  ...
  { id: "file-name-sanitizer", name: "File Name Sanitizer", href: "/file-name-sanitizer", category: "Utility", description: "Clean unsafe or messy filenames.", status: "Live" },
  {
    ...
    isNew: true,
    isFeatured: true,
    seoTitle: "Free Image Compressor & Resizer Online (No Server Upload) | BoringTools",
    seoDescription: "Compress and resize JPG, PNG, and WebP images directly inside your browser without uploading to any server. 100% private, fast, and free.",
    keywords: ["image compressor", "compress image online", "compress jpg without upload", "free image resizer", "browser image compression"],
    relatedToolIds: ["background-remover", "image-to-pdf-converter", "gif-maker", "image-to-ascii"]
  },
  { id: "gif-maker", name: "GIF Maker from Images", href: "/gif-maker", category: "Media", description: "Create animated GIFs from multiple images with custom transitions, delays, text overlays, and filters 100% locally.", status: "Live", isNew: true, isFeatured: true },
  {
    ...
    status: "Live",
    isNew: true,
    seoTitle: "Free Image to PDF Converter — Convert JPG & PNG to PDF in Browser | BoringTools",
    seoDescription: "Convert multiple JPG, PNG, and WebP images into a single clean PDF document offline in your browser. 100% client-side privacy, no file limits.",
    keywords: ["image to pdf converter", "jpg to pdf online", "convert png to pdf free", "image to pdf no upload", "browser image to pdf"],
    relatedToolIds: ["image-compressor", "pdf-merger", "doc-to-pdf-converter", "background-remover"]
  },
  { id: "doc-to-pdf-converter", name: "DOC to PDF Converter", href: "/doc-to-pdf-converter", category: "Documents", description: "Upload DOC or DOCX files and convert them into a downloadable PDF.", status: "Live", isNew: true },
  {
    ...
    isNew: true,
    isFeatured: true,
    seoTitle: "Free PDF Merger Online — Combine PDF Files in Browser | BoringTools",
    seoDescription: "Merge and combine multiple PDF documents into one single file offline in your browser. No file size limits, zero server uploads, 100% private.",
    keywords: ["pdf merger", "merge pdf online free", "combine pdf files", "merge pdf without upload", "client side pdf merger"],
    relatedToolIds: ["doc-to-pdf-converter", "image-to-pdf-converter", "pdf-intelligence-tool", "document-data-extractor"]
  },
  ...
  { id: "roast-my-todo-list", name: "Roast My To-Do List", href: "/roast-my-todo-list", category: "Productivity", description: "Playful roast with practical next steps.", status: "Live", isNew: true },
  ...
  { id: "linkedin-post-formatter", name: "LinkedIn Post Formatter", href: "/linkedin-post-formatter", category: "Career", description: "Create engaging LinkedIn posts tailored to your audience.", status: "Live", isNew: true },
  { id: "what-happened-today", name: "What Happened Today In History", href: "/what-happened-today", category: "Education", description: "Discover major historical events that happened on this day.", status: "Live", isNew: true },
  ...
  { id: "concept-explorer", name: "QuickLearn", href: "/concept-explorer", category: "Education", description: "Explore any topic with quick explanations, examples, and guided next steps.", status: "Live", isNew: true },
  ...
  { id: "social-account-analyzer", name: "Social Account Analyzer", href: "/social-account-analyzer", category: "Creator Tools", description: "Audit Instagram, YouTube, X, TikTok, or LinkedIn. Detect spam followers, consistency, and get a custom AI growth roadmap.", status: "Live", isNew: true },
  ...
  { id: "youtube-downloader", name: "YouTube Downloader", href: "/youtube-downloader", category: "Media", description: "Download videos, captions, and thumbnails from YouTube. Best used locally for full functionality.", status: "Live", isNew: true },
  {
    ...
    isNew: true,
    isFeatured: true,
    seoTitle: "Free YouTube Playlist Length Calculator & Duration Checker | BoringTools",
    seoDescription: "Calculate total watch time and duration for any YouTube playlist at 1x, 1.25x, 1.5x, 1.75x, and 2x speed. Instant results with zero signup.",
    keywords: ["youtube playlist length calculator", "youtube playlist duration", "calculate youtube playlist time", "youtube playlist time calculator", "youtube watch time planner"],
    relatedToolIds: ["youtube-downloader", "youtube-title-generator", "video-to-audio-converter", "video-transcriber"]
  },
  { id: "video-to-audio-converter", name: "Video to Audio Converter", href: "/video-to-audio-converter", category: "Media", description: "Upload a video and extract audio in MP3, M4A, WAV, or FLAC format.", status: "Live", isNew: true, isFeatured: true },
  {
    ...
    isNew: true,
    isFeatured: true,
    seoTitle: "Free Typing Speed Test — Real-Time WPM & Accuracy Tester | BoringTools",
    seoDescription: "Test your typing speed (Words Per Minute) and accuracy in real-time with live keystroke tracking and performance breakdowns.",
    keywords: ["typing speed test", "wpm test online", "typing accuracy tester", "free typing speed test", "typing test without login"],
    relatedToolIds: ["reaction-time-tester", "word-counter", "markdown-previewer", "text-formatter"]
  },
  ...
  { id: "history-repeats", name: "History Repeats", href: "/history-repeats", category: "Education", description: "Compare modern situations to historical events, revealing patterns, similarities, differences, and key lessons.", status: "Live", isNew: true, isFeatured: true },
  { id: "historical-perspective", name: "Historical Perspective", href: "/historical-perspective", category: "Education", description: "Analyze modern trends and situations through the lens of history, comparing patterns, timelines, and outcomes 100% locally.", status: "Live", isNew: true, isFeatured: true },
  { id: "before-after", name: "Before & After", href: "/before-after", category: "Education", description: "Explore how life changed before and after major inventions, scientific discoveries, and historical breakthroughs.", status: "Live", isNew: true, isFeatured: true },
  { id: "empire-simulator", name: "Empire Simulator", href: "/empire-simulator", category: "Education", description: "Build and manage a fictional empire to simulate growth, random historical events, and collapse risks.", status: "Live", isNew: true, isFeatured: true },
  { id: "timeline-comparison", name: "Timeline Comparison", href: "/timeline-comparison", category: "Education", description: "Visually compare two historical civilizations, empires, inventions, technologies, or events side-by-side across time.", status: "Live", isNew: true, isFeatured: true },
  { id: "if-this-never-happened", name: "If This Never Happened", href: "/if-this-never-happened", category: "Education", description: "Explore alternate history by simulating how the world would look today if a major event or invention never occurred.", status: "Live", isNew: true, isFeatured: true },
  { id: "your-weight-on-other-planets", name: "Your Weight on Other Planets", href: "/your-weight-on-other-planets", category: "Education", description: "Calculate your weight, jump height, and lifting capacity across different planets and moons in our Solar System.", status: "Live", isNew: true, isFeatured: true },
  { id: "cosmic-calendar", name: "Cosmic Calendar", href: "/cosmic-calendar", category: "Education", description: "Understand the scale of time by compressing the history of the universe into a calendar year and comparing it to your life.", status: "Live", isNew: true, isFeatured: true },
  { id: "cosmic-address", name: "Cosmic Address", href: "/cosmic-address", category: "Education", description: "Trace your exact location in the universe, zooming out from yourself to the edge of the observable universe with interactive visualizations.", status: "Live", isNew: true, isFeatured: true },
  { id: "time-on-other-planets", name: "Time on Other Planets", href: "/time-on-other-planets", category: "Education", description: "Compare planetary years, days, birthdays, and age across the Solar System with orbital maps and comparisons.", status: "Live", isNew: true, isFeatured: true },
  ...
  { id: "cinematic-ai-prompt-architect", name: "Cinematic AI Prompt Architect", href: "/cinematic-ai-prompt-architect", category: "Creator Tools", description: "Create production-quality cinematic AI prompts for image and video generation.", status: "Live", isNew: true, isFeatured: true },
  {
    ...
    isNew: true,
    isFeatured: true,
    seoTitle: "Free Fake Data Generator for Developers (JSON, SQL, CSV) | BoringTools",
    seoDescription: "Generate realistic fake names, emails, addresses, credit cards, and SQL/JSON mock datasets directly in your browser. 100% free and private.",
    keywords: ["fake data generator", "mock data generator", "test data generator online", "generate dummy data", "sql mock data generator"],
    relatedToolIds: ["json-formatter", "password-generator", "qr-generator", "markdown-previewer"]
  },
  { id: "movie-series-recommendation", name: "Movie & Series Recommendation", href: "/movie-series-recommendation", category: "Fun", description: "Find the perfect movie or TV series based on mood, genre, available time and preferences. Save favorites and build your personal watchlist. Runs completely in your browser.", status: "Live", isNew: true, isFeatured: true },
  ...
  { id: "ai-agent-visualizer", name: "AI Agent Visualizer", href: "/ai-agent-visualizer", category: "Education", description: "Understand how modern AI agents think, plan, use tools, remember information, and work in multi-agent networks.", status: "Live", isNew: true, isFeatured: true },
  ...
  { id: "startup-name-analyzer", name: "Startup Name Analyzer", href: "/startup-name-analyzer", category: "Creator Tools", description: "Analyze your startup name for memorability, branding, pronunciation, global appeal, emotional impact, and market readiness.", status: "Live", isNew: true, isFeatured: true },
  {
    ...
    isNew: true,
    isFeatured: true,
    seoTitle: "Free Reaction Time & Mouse Accuracy Test (Benchmark Reflexes) | BoringTools",
    seoDescription: "Benchmark your reaction speed, click reflexes, and mouse aiming precision in milliseconds across 5 competitive training modes. Free and browser-first.",
    keywords: ["reaction time test", "mouse accuracy test", "reflex test online", "benchmark reaction speed", "aim trainer online"],
    relatedToolIds: ["typing-speed-tester", "bmi-calculator", "pomodoro-timer", "suiii-counter"]
  },
  {
    ...
    isNew: true,
    isFeatured: true,
    seoTitle: "Free AI Background Remover (100% Client-Side Privacy) | BoringTools",
    seoDescription: "Remove image backgrounds instantly in your web browser with local AI. Zero server uploads, zero sign-up, ultra-fast and 100% private.",
    keywords: ["remove background free", "ai background remover", "remove bg without upload", "transparent background maker", "browser background remover"],
    relatedToolIds: ["image-compressor", "image-to-pdf-converter", "gif-maker", "aspect-ratio-calculator"]
  },
