...
const tool = tools.find((t) => t.id === "pdf-intelligence-tool") || {
  id: "pdf-intelligence-tool",
  name: "PDF Intelligence Tool",
  href: "/pdf-intelligence-tool",
  category: "Documents",
  description: "Upload PDFs and extract summaries, key points, contacts, links, and document stats.",
  status: "Live",
};
