...
const tool = tools.find((t) => t.id === "doc-to-pdf-converter") || {
  id: "doc-to-pdf-converter",
  name: "DOC to PDF Converter",
  href: "/doc-to-pdf-converter",
  category: "Documents",
  description: "Upload DOC or DOCX files and convert them into a downloadable PDF.",
  status: "Live",
};
