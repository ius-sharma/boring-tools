...
const tool = tools.find((t) => t.id === "perspective-switcher") || {
  id: "perspective-switcher",
  name: "Perspective Switcher",
  href: "/perspective-switcher",
  category: "Productivity",
  description: "Reframe your dilemmas and view problems from five distinct personal and objective viewpoints.",
  status: "Live",
};
