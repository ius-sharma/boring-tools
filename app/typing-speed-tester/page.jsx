...
export default function TypingSpeedTester() {
  ...
  useEffect(() => {
    recordRecentTool("typing-speed-tester");
  }, []);
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4 font-sans pt-24 pb-12 transition-colors duration-200">
          ...
          <div className="flex flex-col gap-6 animate-fadeIn">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-4 gap-3">
              ...
              <button
                ...
                className="rounded-xl border border-orange-600 bg-orange-600 px-4 py-3.5 font-semibold text-white shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:bg-orange-700 hover:shadow-md focus:outline-none focus:ring-2 focus:ring-orange-600 cursor-pointer text-sm text-center flex items-center justify-center gap-1.5"
              >
      ...
      <ShareResultCardModal
        ...
        data={shareCard}
        filename="boringtools-typing-speed.png"
        tweetText={
          shareCard
            ? `I just scored ${shareCard.wpm} WPM with ${shareCard.accuracy}% accuracy on BoringTools! Can you beat my score? ⌨️⚡`
            : "Check out my typing speed test!"
        }
        shareUrl="https://www.boringtoolsai.com/typing-speed-tester"
      />
