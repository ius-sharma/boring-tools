    ...
    <div className="min-h-screen bg-neutral-50 flex items-center justify-center p-4 font-sans">
      <div className="bg-white/80 backdrop-blur shadow-xl rounded-2xl p-8 w-full max-w-xl border border-neutral-200 flex flex-col gap-6">
        <div className="flex flex-col gap-1 items-center">
          <h1 className="text-3xl font-bold tracking-tight text-neutral-900 mb-1">QR Generator</h1>
          <p className="text-neutral-500 text-base">Generate a QR code from text or links instantly</p>
        </div>
        ...
        {qr ? (
          <div className="w-full p-4 border border-neutral-200 rounded-xl bg-neutral-50 flex flex-col items-center gap-4">
            <img src={qr} alt="Generated QR Code" className="w-48 h-48 rounded-lg bg-white p-2 border border-neutral-200" />
